...
public class CarService {
	...
	public void makeForm() {
		makeForm(FORM_INSERT, new Car(), FORM_ORDERBY_DESCRICAO);
	}

	
	public void makeForm(int orderBy) {
		makeForm(FORM_INSERT, new Car(), orderBy);
	}

	
	public void makeForm(int tipo, Car produto, int orderBy) {
		...
		if(tipo == FORM_INSERT || tipo == FORM_UPDATE) {
			...
			umProduto += "\t\t\t<td>Quantidade: <input class=\"input--register\" type=\"text\" name=\"quantidade\" value=\""+ produto.getMarca() +"\"></td>";
			umProduto += "\t\t</tr>";
			umProduto += "\t\t<tr>";
			umProduto += "\t\t\t<td>&nbsp;Data de fabricação: <input class=\"input--register\" type=\"text\" name=\"dataFabricacao\" value=\""+ "\"></td>";
			umProduto += "\t\t\t<td>Data de validade: <input class=\"input--register\" type=\"text\" name=\"dataValidade\" value=\""+ "\"></td>";
			...
			umProduto += "\t\t\t<td>Quantidade: "+ produto.getMarca() +"</td>";
			umProduto += "\t\t</tr>";
			umProduto += "\t\t<tr>";
			umProduto += "\t\t\t<td>&nbsp;Data de fabricação: "+ "</td>";
			umProduto += "\t\t\t<td>Data de validade: "+ "</td>";
			umProduto += "\t\t\t<td>&nbsp;</td>";
			umProduto += "\t\t</tr>";
			umProduto += "\t</table>";		
		} else {
		...
		List<Car> produtos;
		if (orderBy == FORM_ORDERBY_ID) {                 	produtos = carDAO.getOrderByID();
		} else if (orderBy == FORM_ORDERBY_DESCRICAO) {		produtos = carDAO.getOrderByDescricao();
		} else if (orderBy == FORM_ORDERBY_PRECO) {			produtos = carDAO.getOrderByPreco();
		} else {											produtos = carDAO.get();
		}
	...
	public Object insert(Request request, Response response) {
		...
		Car produto = new Car(-1, descricao, preco, marca);
		
		if(carDAO.insert(produto) == true) {
